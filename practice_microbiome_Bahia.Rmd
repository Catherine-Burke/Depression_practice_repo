...
#Create object of sample data for easy reference in R studio
practice2017_data<-as.matrix(sample_data(practice2017))
...
type<-practice2017_data$Type
#col <- c("forestgreen", "red", "hotpink", "black", "blue")
#cols<-col[sinus2017_data$Type]
curve<-rarecurve(t_otu_practice2017, step=1000, label=FALSE, xlim= c(0,50000), ylim=c(0,500), ylab = "OTU Count", xaxt="n")
...
practice2017_rare<-rarefy_even_depth(sinus2017, sample.size=6000, rngseed=711, replace=FALSE, trimOTUs=TRUE)
```
...
sinus_swabs_richness<-cbind(practice2017_rare_richness,sample_data(practice2017_rare))
